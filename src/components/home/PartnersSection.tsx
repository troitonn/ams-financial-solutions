...
const PartnersSection = () => {
  ...
  return <section className="py-12 md:py-16 bg-gradient-to-b from-ams-darkGray to-ams-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-bold mb-3 gradient-gold glow-text">Nossos Bancos Parceiros</h2>
          <p className="text-gray-300 max-w-2xl mx-auto mb-8">
            Instituições financeiras que confiam em nossa expertise
          </p>
        </div>
        
        <div className="pt-2" ref={carouselRef}>
          <Carousel opts={{
          align: "start",
          loop: true,
          dragFree: true
        }} className="w-full max-w-4xl mx-auto" onMouseEnter={() => {
          if (carouselRef.current) {
            const scrollElement = carouselRef.current.querySelector('.embla__container');
            if (scrollElement) {
          ...
          if (carouselRef.current) {
            ...
            <CarouselContent>
              {["/lovable-uploads/7f39c7d0-c637-4b1c-9f98-861435e4f32d.png", "/lovable-uploads/e6551330-38cd-4a6d-9658-349863f259fd.png", "/lovable-uploads/2a802623-4b77-477f-8f9b-94f5f3230c14.png", "/lovable-uploads/6951004f-af2f-41b4-82d3-3192c9f2b86e.png", "/lovable-uploads/a0cec4f0-c912-4b8e-a768-0b036c8d0416.png", "/lovable-uploads/68a674b3-42d7-4caa-97de-0d6d25468170.png", "/lovable-uploads/03a2799b-6984-4e84-8b4f-f6db7a39c3f8.png"].map((src, idx) => <CarouselItem key={idx} className="md:basis-1/4 px-1 mx-111">
                  <motion.div style={{
                opacity
              }} whileHover={{
                scale: 1.05
              }} className="bg-white p-4 rounded-full h-24 w-24 flex items-center justify-center shadow-lg hover:shadow-ams-gold/30 transition-all duration-300 mx-auto">

...
const PartnersSection = () => {
  ...
  return (
    <section className="py-12 md:py-16 bg-gradient-to-b from-ams-darkGray to-ams-black relative overflow-hidden">
          ...
          >
            <CarouselContent>
              {[
                ...
                <CarouselItem key={idx} className="md:basis-1/4 px-1 mx-1">
                  <motion.div
                    style={{ opacity }}

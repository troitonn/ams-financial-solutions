...
const PartnersSection = () => {
  ...
  return <section className="py-16 md:py-20 bg-gradient-to-b from-ams-darkGray to-ams-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="pt-4" ref={carouselRef}>
          ...
          loop: true,
          dragFree: true
        }} className="w-full max-w-5xl mx-auto" onMouseEnter={() => {
          if (carouselRef.current) {
            const scrollElement = carouselRef.current.querySelector('.embla__container');
            if (scrollElement) {

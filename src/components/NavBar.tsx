      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex justify-between items-center">
          ...
          <a 
            ...
            className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:py-2 focus:px-4 focus:bg-ams-gold focus:text-ams-black focus:rounded"
          >
            ...
            >
              ...
              <div className={`absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-ams-black border border-ams-gold/20 transition-opacity duration-150 ${dropdownOpen ? 'opacity-100' : 'opacity-0 invisible'}`}>
                <div className="py-1 glass-card">
                  ...
                  <Link to="/fundador" className="block px-4 py-2 text-white hover:bg-ams-gold/10 hover:text-ams-gold">
                    Fundador
                  </Link>
                  <Link to="/integridade" className="block px-4 py-2 text-white hover:bg-ams-gold/10 hover:text-ams-gold">
                    Integridade
                  </Link>
                </div>
              </div>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="py-2">
                ...
                <div className="ml-4 space-y-2 border-l border-ams-gold/30 pl-4">
                  <Link 
                    to="/sobre" 
                    className="block text-white hover:text-ams-gold transition duration-200"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    Sobre a A.M.S
                  </Link>

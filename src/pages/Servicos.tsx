    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80')] bg-cover bg-center"></div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 text-center">
              <a
                href="https://wa.me/5511999285273?text=Olá,%20gostaria%20de%20saber%20mais%20sobre%20os%20serviços%20da%20A.M.S"
                target="_blank"
                rel="noreferrer"
                className="gold-button px-8 py-4 text-lg rounded-md font-medium inline-flex items-center"
              >
